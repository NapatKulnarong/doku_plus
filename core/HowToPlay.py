...
class HowToPlay:
    def __init__(self, screen):
        ...
        self.body_font = pygame.font.Font("assets/fonts/nunito_bold.ttf", int(19 * 1.3))  # 25
        self.button_font = pygame.font.Font("assets/fonts/nunito_bold.ttf", int(20 * 1.3))  # 26
        # Scaled back button (100*1.3=130, 80*1.3=104, 200*1.3=260, 50*1.3=65)
        self.back_button = pygame.Rect(WIDTH // 2 - int(100 * 1.3), HEIGHT - int(80 * 1.3), int(200 * 1.3), int(50 * 1.3))  # -130, -104, 260, 65
    ...
    def draw(self):
        ...
        self.screen.blit(title, title.get_rect(center=(WIDTH // 2, int(60 * 1.3))))  # 78

        # Instruction Box (40*1.3=52, 120*1.3=156, 400*1.3=520)
        box_x = int(40 * 1.3)  # 52
        box_y = int(120 * 1.3)  # 156
        box_width = WIDTH - 2 * box_x
        box_height = int(400 * 1.3)  # 520
        ...
        for i, line in enumerate(instructions):
            ...
            self.screen.blit(rendered, (box_x + int(20 * 1.3), box_y + int(20 * 1.3) + i * int(35 * 1.3)))  # 26, 26, 46
